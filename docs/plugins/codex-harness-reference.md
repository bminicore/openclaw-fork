...
| `nativeHookRelayTimeoutSec`                   | `20`                                                   | Maximum time for a Codex native hook relay subprocess. Its child command receives a bounded parent margin so it can return before Codex terminates the hook.                                                                                                                                                                                                                                |
